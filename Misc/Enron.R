# Enron e-mail network annalysis

# store data set away from cloud synced folder
# Enron Email Dataset: https://www.cs.cmu.edu/~./enron/
if (!file.exists("~/Desktop/enron_mail_20150507.tgz")) {
    download.file("https://www.cs.cmu.edu/~./enron/enron_mail_20150507.tgz", 
              destfile = "~/Desktop/enron_mail_20150507.tgz")
}
if (!file.exists("~/Desktop/enron_mail_20150507.tgz")) {
    untar("~/Desktop/enron_mail_20150507.tgz", exdir = "../../Desktop/")
}

# E-mail corpus consists of nested folders per user with e-mails as text files
# Create list of all available e-mails
emails <- list.files("~/Desktop/maildir/", full.names = T, recursive = T)
length(emails)
