...
$$H_2: R_{ideal,age} >0$$
\section{Method}
\label{sec:org2e58096}
\subsection{Participants}
\label{sec:org50e207a}
...
\section{Results}
\label{sec:org6cc8554}
\subsection{Body Image}
\label{sec:orgf9012d3}
...
\end{center}
\section{Discussion}
\label{sec:org6fd960d}
\subsection{Body Dissatisfaction}
\label{sec:org6a5f43e}
