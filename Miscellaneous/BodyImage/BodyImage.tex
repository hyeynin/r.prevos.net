...
\label{sec:org325b344}
\citeA{turner_influence_1997}
...
$$H_2: R_{ideal,age} >0$$
\section{Method}
\label{sec:org0e6e454}
\subsection{Participants}
\label{sec:org4fe3fce}
...
\section{Results}
\label{sec:org30d1fa9}
\subsection{Body Image}
\label{sec:orgb3e6eea}
...
\end{center}
\section{Discussion}
\label{sec:org2aec490}
\subsection{Body Dissatisfaction}
\label{sec:org61a1d28}
