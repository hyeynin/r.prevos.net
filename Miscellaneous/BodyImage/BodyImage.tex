...
$$H_2: R_{ideal,age} >0$$
\section{Method}
\label{sec:orgdba6790}
\subsection{Participants}
\label{sec:org8803ada}
...
\section{Results}
\label{sec:org4b804ed}
\subsection{Body Image}
\label{sec:orgad15a3d}
...
\end{center}
\section{Discussion}
\label{sec:orga9dc97d}
\subsection{Body Dissatisfaction}
\label{sec:org7136026}
